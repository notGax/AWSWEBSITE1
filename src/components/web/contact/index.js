        ...
        return (
            ...
            est, qui dolorem ipsum quia dolor sit amet, consectetur</p>
                                <ul className="contact-list">
                                    <li> <i className="fa fa-map-marker" aria-hidden="true" /> Vellore,Tamil Nadu, India.</li>
                                        ...
                                        <div className="resp-tabs-container hor_1">
                                            ...
                                            <div>
                                                <div className="map-grid">
                                                    <h5>Our Branches</h5>
                                                    <ul>
                                                        <li><i className="fa fa-arrow-right" aria-hidden="true" />Vellore,Tamil Nadu, India.</li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div>
                                                <div className="map-grid">
                                                    ...
                                                    <ul>
                                                        <li>Mobile No : +91 xxxxxxxxx</li>
                                                        <li>Phone No : +91 xxxxxxxxx</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
